...
def derive():
    ...
    derive = sp.diff(der_function, with_respect) #l' derivee is done avec l'aide d'l'sympy. 
    stringed= str(derive) # alors, it is turned into un string con el fin d' graph ce. 
